    ...
    <>
      <header className="bg-white drop-shadow-md sticky  z-[1000] top-0 w-full">
        ...
        >
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <Link
              ...
              rel="noreferrer"
              href="#"
              className=" py-2 px-5 lg:px-6 text-base md:px-3 md:text-xs lg:text-lg font-medium rounded-md text-white bg-green outline-0 hover:bg-lemonGreen  lg:font-medium"
            >
              Get Started
            </Link>
          </div>
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 w-full overflow-y-auto bg-red-600 drop-shadow-md h-fit px-6 py-6 sm:ring-1 sm:ring-green">
              ...
              <div className="-my-6 divide-y divide-fadeOrange">
                      ...
                      <Link
                        ...
                        className={({ isActive }) => {
                          return (
                            ...
                            (isActive
                              ? "  text-red-600  font-bold text-lg uppercase"
                ...
                <div className="py-6">
                  <Link
                    ...
                    rel="noreferrer"
                    href="#"
                    className="-mx-3 block border-2 hover:text-orange rounded-md px-3 py-2.5 text-base font-semibold leading-7 text-white bg-green hover:bg-green500 w-fit"
                  >
                    Get Started
                  </Link>
                </div>
